...
export class AuthRoutes {
    ...
    initializeRoutes() {
        const router = Router();
        router
            .get('/logout',studentVerifyJWT,wrap(authCtrl.logout))
            .put('/push-message',studentVerifyJWT, wrap(authCtrl.AppPush))
            .post('/login',wrap(authCtrl.loginP))//학교DB 아닌 임시 DB로 로그인
